...
uint256 hashGenesisBlock("0x86cc0e358f1b274388e60e04556a747f904da1578dc486ace49e8b1960e49ac1");
...
static const int64 nTargetTimespan = 2 * 60; // Testcoin: 3.5 days
static const int64 nTargetSpacing = 1 * 24 * 60 * 60; // Testcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x935fd013e52558965f44556d7589ba4970a5bc0385d838644c8008a695168d25");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Just a new coin birth";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x86cc0e358f1b274388e60e04556a747f904da1578dc486ace49e8b1960e49ac1"));
        block.print();
